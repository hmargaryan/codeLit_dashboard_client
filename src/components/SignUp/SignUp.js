  ...
  return (
    <div className={styles.root}>
      ...
      <form className={styles.form}>
        ...
        <Button type="submit" text="Зарегистрироваться" buttonStyle="primary" className={styles.submitButton} />
      </form>
      <p>Уже есть аккаунт? <Link to='/sign-in' className={styles.singInLink}>Войдите</Link></p>
    </div >
  );
};
